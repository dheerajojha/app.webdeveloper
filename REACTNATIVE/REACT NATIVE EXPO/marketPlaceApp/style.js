...
const gStyles = StyleSheet.create({
    ...
    small:{fontSize:14,fontWeight:'600',color:'blue'},
    input:{width:'100%',borderWidth:1,borderColor:'gray',padding:10,borderRadius:5},
    cta:{backgroundColor:'blue',padding:15,width:'100%',borderRadius:30},
    ctaText:{color:'white',textAlign:'center',fontWeight:'600',fontSize:16},
    ctaOutline:{backgroundColor:'white',padding:15,width:'100%',borderRadius:30,borderColor:'blue',borderWidth:2},
